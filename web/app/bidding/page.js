                    ...
                    <aside className="w-64">
                        <nav className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 space-y-2 sticky top-24">
                            {[
                                ...
                                { href: "bidding", label: "Bidding", active: true }
                        ...
                        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                            ...
                            <div className="text-center mb-12">
                                ...
                                <p className="text-lg text-gray-600 mx-auto">
                                    Start a new bidding or join an existing one.
                                </p>
                            </div>
                            ...
                            {!biddingMode ? (
                                <div className="mx-auto space-y-4">
                                    ...
                                    <button
                                        onClick={() => setBiddingMode("start")}
                                        className="w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white py-4 rounded-xl font-semibold hover:shadow-lg transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3"
                                    >
                                        Start Bidding
                                    </button>
                                    ...
                                    {/* Join Bidding Button */}
                                    <button
                                        onClick={() => setBiddingMode("join")}
                                        className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-4 rounded-xl font-semibold hover:shadow-lg transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-3"
                                    >
                                        Join Bidding
                                    </button>
                                </div>
                                ...
                                <div className="mx-auto space-y-6">
                                     ...
                                     {biddingMode !== "start" && (
                                        <div className="text-center mt-4">
                                            <span className="text-sm text-gray-600">
                                                Current Bid: {currentBidPrice ? `${currentBidPrice} ETH` : "-"}
                                            </span>
                                        </div>
                                    )}
                                    {/* Token ID Input */}
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-2">
                                            {biddingMode === "start" ? "Base Price (ETH)" : "Bid Price (ETH)"}
                                        </label>
                                        <div className="relative">
                                            <input
                                                type="text"
                                                placeholder={biddingMode === "start" ? "e.g., 0.5" : "e.g., 0.5"}
                                                value={priceEth}
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <button
                                            ...
                                            className="flex-1 bg-gray-200 text-gray-700 py-4 rounded-xl font-semibold hover:bg-gray-300 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]"
                                        >
                                            Back
                                        </button>
                                        ...
                                        {/* Confirm Button */}
                                        <button
                                            onClick={biddingMode === "start" ? StartBidding : JoinBidding}
                                            disabled={!tokenId || !priceEth}
                                            className={`flex-1 text-white py-4 rounded-xl font-semibold hover:shadow-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-[1.02] active:scale-[0.98] ${
                                                biddingMode === "start" 
                                                    ? "bg-gradient-to-r from-green-500 to-emerald-600" 
                                                    : "bg-gradient-to-r from-purple-600 to-blue-600"
                                            }`}
                                        >
                                            {biddingMode === "start" ? "Start Bidding" : "Place Bid"}
                                        </button>
                                    </div>
                                </div>
                            )}
